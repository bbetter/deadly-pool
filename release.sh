...
#   Exports all platforms, packages versioned zips, generates latest.json.
...
echo "[1/5] Version stamped: ${VER}"

# 3. Export all platforms
echo "[2/5] Exporting builds..."
./export-linux.sh
./export-windows.sh
./export-server.sh

# 4. Package client builds
echo "[3/5] Packaging zips..."
mkdir -p dist
...
echo "[4/5] Generating latest.json..."
...
echo "  Admin:  https://dp.900dfe11a-media.pp.ua/"
